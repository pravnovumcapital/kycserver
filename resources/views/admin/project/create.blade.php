        ...
        {{csrf_field()}}
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="project_title" placeholder="Enter title of the project" name="title" required="">
                </div>
                <div class="form-group">
                  <label>Short Description</label>
                  <textarea class="form-control" rows="2" placeholder="Enter short description about this project!" name="short_description" id="project_short_desc" required=""></textarea>
                </div>
                 <div class="form-group">
                  <label>Detailed Description</label>
                  <textarea class="form-control" rows="4" placeholder="Enter detailed description about this project!" name="detailed_description" id="project_detailed_desc" required=""></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="sale-period-div box">
                  <div class="box-header with-border">
                  <label for="project_logo">Add sale periods</label>
                ...
                <div class="payment-div box">
                  ...
                  <div class="payment-mode-content">
                    <div class="form-group">
                      ...
                      <input type="hidden" id="payment_added" name="payment_methods_array">
                    </div>
                    <div class="payment-mode-append-div"></div>
                  </div>
                 </div>
